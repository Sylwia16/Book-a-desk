...
class DesksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create desk" do
    assert_difference("Desk.count") do
      post desks_url, params: { desk: { Availability: @desk.Availability, Description: @desk.Description, DeskID: @desk.DeskID } }
    end
  ...
  test "should update desk" do
    patch desk_url(@desk), params: { desk: { Availability: @desk.Availability, Description: @desk.Description, DeskID: @desk.DeskID } }
